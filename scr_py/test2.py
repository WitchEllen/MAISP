# https://blog.csdn.net/weixin_43842653/article/details/88938415
import numpy as np
import cv2 as cv
import imutils
...
class Stitcher:
    ...
    #                        flags=2)
    #     img = cv.drawMatches(img1, kp1, img2, kp2, matches, None,
    #                          **draw_params)
...
def show():
    img1 = cv.imread('data/left.jpg')
    img2 = cv.imread('data/right.jpg')
    ...
    cv.imwrite('result_v2.jpg', result)
    cv.imwrite('vis_v2.jpg', vis)
    # cv.waitKey(0)
